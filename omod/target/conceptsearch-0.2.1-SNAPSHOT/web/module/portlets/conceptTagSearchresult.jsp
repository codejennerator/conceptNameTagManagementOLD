...
<table class="openmrsSearchTable">
	<tr>
		...
		<th><spring:message code="Concept.tag" /><a href="?sort=conceptDatatype&order=desc"><img style="width: 14px; height: 14px;" border="0" src="<%=request.getContextPath()%>/images/movedown.gif"></a><a href="?sort=conceptDatatype&order=asc"><img style="width: 14px; height: 14px;" border="0" src="<%=request.getContextPath()%>/images/moveup.gif"></a></th>
		<!-- <th>Other Names</th> -->
